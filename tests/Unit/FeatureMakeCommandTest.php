...
test('stub file has attribute imports', function () {
    ...
    expect($content)->toContain('use OffloadProject\\Hoist\\Attributes\\Label;')
        ...
        ->and($content)->not->toContain('use OffloadProject\\Hoist\\Attributes\\Route;')
        ->and($content)->not->toContain('use OffloadProject\\Hoist\\Attributes\\Tags;')
        ->and($content)->not->toContain('use OffloadProject\\Hoist\\Attributes\\FeatureSet;');
});
