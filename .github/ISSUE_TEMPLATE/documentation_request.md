...
Which file or section needs updating? (e.g., `README.md`, installation guide, attributes table, facade methods, Pennant integration, CHANGELOG)
...
Explain who benefits and how (e.g., new adopters, upgraders, contributors).
